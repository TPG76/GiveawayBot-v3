...
.addField(`Links:`,`- [Youtube Channel](https://youtube.com/@Teg_Pro_Gaming)\n- [Discord Server](https://discord.gg/Wv6hjs7PYE)\n- [GitHub](https://github.com/TPG76)`,true)
.setTimestamp()
.setFooter({
  text: `Requested by ${message.author.username} | GiveawayBot™ v3 By Teg Pro Gaming`, 
  ...
  .setTimestamp()
  .setFooter({
    text: `Requested by ${message.author.username} | GiveawayBot™ v3 Teg Pro Gaming`, 
    iconURL: message.author.displayAvatarURL()
  });
